...
description: Typ av QR som kommer att användas förBarcodeConfig../aspose.omr.generation.config.elements/barcodeconfig Ansvarig för maximalt antal byte kodade av QR. Om du är osäker  användAuto . Biblioteket väljer automatiskt lämplig storlek
type: docs
weight: 490
