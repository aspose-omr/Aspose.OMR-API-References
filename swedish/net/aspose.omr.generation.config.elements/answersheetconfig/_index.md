...
description: Representerar AnswerSheetelement. Det gör det möjligt att lägga till valrutor grupperade i kolumner och rader. Använd svarsbladet om du vill få plats med många frågor på en sida eftersom de ligger nära varandra.
type: docs
weight: 80
