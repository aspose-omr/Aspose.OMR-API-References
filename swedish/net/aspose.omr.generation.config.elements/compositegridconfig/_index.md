...
description: Grid element. Producera en mängd bubblor. Varje fylld bubbla representerar en symbol i sammansatt värde Alla markerade symboler kommer att sammanfogas till ett enda värde
type: docs
weight: 110
