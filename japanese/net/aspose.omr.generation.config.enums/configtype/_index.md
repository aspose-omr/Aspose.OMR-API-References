...
description: Aspose.OMR.Generation.Config.Enums.ConfigType 列挙. Omr 要素のタイプ
type: docs
weight: 460
url: /ja/net/aspose.omr.generation.config.enums/configtype/
---
...
| Column | `177` | エイリアス。[`ContentConfig`](../../aspose.omr.generation.config.elements/contentconfig/) |
...
| Header | `199` | エイリアス。[`TableHeaderConfig`](../../aspose.omr.generation.config.elements.table/tableheaderconfig/) |
