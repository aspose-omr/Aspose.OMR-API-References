...
| Klasse | Beschreibung |
| --- | --- |
| [ImageCollection](./imagecollection) | Sammlung von Bildern, die für die Vorlagengenerierung verwendet werden können. zB[`GenerateTemplate`](../aspose.omr.api/omrengine/generatetemplate) Kann nützlich sein, wenn sich Ihre Bilder nicht im Dateisystem befinden. |
