...
| Class | Description |
| --- | --- |
| [ImageCollection](./imagecollection) | Collection of Images that can be used for template Generation. e.g. [`GenerateTemplate`](../aspose.omr.api/omrengine/generatetemplate) |
