...
description: "Αφηρημένη κλάση που αντιπροσωπεύει τη βασική ερώτηση omr. Περιέχει κοινές ιδιότητες για όλες τις ερωτήσεις"
type: docs
weight: 21
url: /el/java/com.aspose.omr/omrelement/
---
...
Αφηρημένη κλάση που αντιπροσωπεύει τη βασική ερώτηση OMR. Περιέχει κοινές ιδιότητες για όλες τις ερωτήσεις
## Κατασκευαστές
