...
description: Aspose.OMR.Generation.Config.Enums.ConfigType αρίθμηση. Τύπος στοιχείου Omr
type: docs
weight: 460
url: /el/net/aspose.omr.generation.config.enums/configtype/
---
...
| Column | `177` | Ψευδώνυμο.[`ContentConfig`](../../aspose.omr.generation.config.elements/contentconfig/) |
...
| Header | `199` | Ψευδώνυμο.[`TableHeaderConfig`](../../aspose.omr.generation.config.elements.table/tableheaderconfig/) |
