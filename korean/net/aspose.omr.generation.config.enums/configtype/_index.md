...
description: Aspose.OMR.Generation.Config.Enums.ConfigType 열거형. Omr Element 의 유형
type: docs
weight: 460
url: /ko/net/aspose.omr.generation.config.enums/configtype/
---
...
| Column | `177` | 별칭.[`ContentConfig`](../../aspose.omr.generation.config.elements/contentconfig/) |
...
| Header | `199` | 별칭.[`TableHeaderConfig`](../../aspose.omr.generation.config.elements.table/tableheaderconfig/) |
