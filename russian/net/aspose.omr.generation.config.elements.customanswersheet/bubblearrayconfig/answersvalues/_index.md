...
description: Каждое значение представляет собой символ внутри пузырька. Должен иметь тот же счет что иAnswersCount Пример новая строка A B C D Пример новая строка 1 2 3 4
type: docs
weight: 20
