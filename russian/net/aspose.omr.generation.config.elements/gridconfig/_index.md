...
description: Представляет таблицу пузырьков. Идентификатор вопроса и несколько ответов на выбор Строка ответов может быть горизонтальной или вертикальной
type: docs
weight: 180
