...
description: "Абстрактный класс, представляющий базовый вопрос omr. Содержит общие свойства для всех вопросов"
type: docs
weight: 21
url: /ru/java/com.aspose.omr/omrelement/
---
...
Абстрактный класс, представляющий базовый вопрос OMR, содержит общие свойства для всех вопросов
## Конструкторы
