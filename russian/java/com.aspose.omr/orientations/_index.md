...
description: "Возможная ориентация вопроса"
type: docs
weight: 26
url: /ru/java/com.aspose.omr/orientations/
---
...
Возможная ориентация вопроса
## Поля

| Поле | Описание |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Horizontal](#Horizontal) | Горизонтальная ориентация |
| [Vertical](#Vertical) | Вертикальная ориентация |
## Методы
