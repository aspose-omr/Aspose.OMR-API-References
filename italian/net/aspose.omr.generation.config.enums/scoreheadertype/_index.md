...
description: Tipo di intestazione del punteggio.
type: docs
weight: 520
...
| Amount | `2` | Questa intestazione di colonna memorizzerà il valore del punteggio. ad es. "2" o "4" Può essere utilizzato solo conDisplayAsExtraColumn |
| Question | `3` | In questa colonna: intestazione - testo della domanda. Righe - risposte |
| Content | `4` | In questa colonna è possibile inserire contenuti personalizzati. Header - header text Rows - Elemento di contenuto con riga e colonna specificate |
