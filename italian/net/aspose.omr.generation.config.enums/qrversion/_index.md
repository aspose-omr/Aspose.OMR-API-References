...
description: Tipo di QR che verrà utilizzato perBarcodeConfig../aspose.omr.generation.config.elements/barcodeconfig Responsabile della quantità massima di byte codificati da QR. In caso di dubbi utilizzareAuto . La libreria selezionerà automaticamente la dimensione appropriata
type: docs
weight: 490
...
Tipo di QR che verrà utilizzato per[`BarcodeConfig`](../../aspose.omr.generation.config.elements/barcodeconfig) Responsabile della quantità massima di byte codificati da QR. In caso di dubbi, utilizzareAuto . La libreria selezionerà automaticamente la dimensione appropriata
