...
description: Bolla personalizzata. Al momento del riempimento può cambiare il comportamentovalore degli elementi target
type: docs
weight: 160
...
Bolla personalizzata. Al momento del riempimento può cambiare il comportamento\valore degli elementi target
...
| Nome | Descrizione |
| --- | --- |
| [BubbleType](../../aspose.omr.generation.config.elements/customtriggerconfig/bubbletype) { get; set; } | Il tipo di una bolla |
| override [Name](../../aspose.omr.generation.config.elements/customtriggerconfig/name) { get; set; } | Nome del trigger. |
| [Target](../../aspose.omr.generation.config.elements/customtriggerconfig/target) { get; set; } | Nome dell'elemento di destinazione. Il comportamento dipende[`TriggerType`](./triggertype) |
