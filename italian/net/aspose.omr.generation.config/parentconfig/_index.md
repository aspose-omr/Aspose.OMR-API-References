...
description: Astrazione che contrassegna lelemento come genitore e consente di avere altri elementi come figli
type: docs
weight: 550
...
| Nome | Descrizione |
| --- | --- |
| abstract [Children](../../aspose.omr.generation.config/parentconfig/children) { get; set; } | Elementi omr figlio. Nella maggior parte dei casi posizionato all'interno del genitore o sotto. |
