...
description: Colonna inScoreGroupConfig./scoregroupconfig che memorizzerà la quantità di punti per ogni risposta. Se assente quella colonna non verrà disegnata.
type: docs
weight: 300
...
Colonna in[`ScoreGroupConfig`](../scoregroupconfig) che memorizzerà la quantità di punti per ogni risposta. Se assente, quella colonna non verrà disegnata.
...
| override [Name](../../aspose.omr.generation.config.elements.scoregroup/scoreheaderconfig/name) { get; set; } | Titolo dell'intestazione della colonna |
