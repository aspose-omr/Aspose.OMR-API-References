...
description: Grid element. Produire un tableau de bulles. Chaque bulle remplie représente un symbole dans la valeur composite Tous les symboles marqués seront concaténés en une seule valeur
type: docs
weight: 110
