...
| --- | --- |
| [ImageCollection](./imagecollection) | Collection d'images pouvant être utilisées pour la génération de modèles. par exemple[`GenerateTemplate`](../aspose.omr.api/omrengine/generatetemplate) Peut être utile lorsque vos images ne sont pas dans le système de fichiers. |
