...
description: Classe pour le traitement des modèles et des images.  Chaque instance de cette classe fonctionne avec un seul modèle OMR. Elle est capable de reconnaître les images du modèle spécifié dans le constructeur.
type: docs
weight: 30
