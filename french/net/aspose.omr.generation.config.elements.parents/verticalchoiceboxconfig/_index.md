...
description: La VerticalChoiceBox se compose dunAnswerConfig./answerconfig élément qui contient une courte réponse etContentConfig../aspose.omr.generation.config.elements/contentconfig éléments décrivant en détail loption de réponse. Il peut également contenir unWriteInConfig../aspose.omr.generation.config.elements/writeinconfig élément dans lequel lutilisateur peut entrer sa propre réponse.
type: docs
weight: 270
