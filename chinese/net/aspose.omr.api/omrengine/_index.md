...
| 姓名 | 描述 |
| --- | --- |
| [GenerateJSONTemplate](../../aspose.omr.api/omrengine/generatejsontemplate)(string, GlobalPageSettings) | 基于 .json 标记创建模板 (.omr) 和模板图像 |
...
| [GenerateTemplate](../../aspose.omr.api/omrengine/generatetemplate#generatetemplate_3)(string) | 基于文本标记创建模板 (.omr) 和模板图像 |
