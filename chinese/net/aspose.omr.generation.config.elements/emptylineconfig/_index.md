...
description: 空元素可用作垂直边距跳过的高度可以通过属性设置
type: docs
weight: 170
...
| 姓名 | 描述 |
| --- | --- |
| [Height](../../aspose.omr.generation.config.elements/emptylineconfig/height) { get; set; } | 高度（以像素为单位）。 |
| override [Name](../../aspose.omr.generation.config.elements/emptylineconfig/name) { get; set; } | 空行名称跳过 - 不绘制或参与识别 |
