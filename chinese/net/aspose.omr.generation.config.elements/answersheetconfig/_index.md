...
| 姓名 | 描述 |
| --- | --- |
| [AnswersCount](../../aspose.omr.generation.config.elements/answersheetconfig/answerscount) { get; set; } | 答题卡中每个问题的答案选项数。 |
...
| [Column](../../aspose.omr.generation.config.elements/answersheetconfig/column) { get; set; } | 表示在哪一列中绘制 sheet |
...
| override [Name](../../aspose.omr.generation.config.elements/answersheetconfig/name) { get; set; } | 答题纸名称 |
| [StartId](../../aspose.omr.generation.config.elements/answersheetconfig/startid) { get; set; } | 题目编号的起始索引 |
