...
| Column | `177` | 别名。[`ContentConfig`](../../aspose.omr.generation.config.elements/contentconfig) |
...
| Header | `199` | 别名。[`TableHeaderConfig`](../../aspose.omr.generation.config.elements.table/tableheaderconfig) |
