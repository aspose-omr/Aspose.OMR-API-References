...
description: 将用于的 QR 类型BarcodeConfig../aspose.omr.generation.config.elements/barcodeconfig 负责由 QR 编码的最大字节数 如果不确定  使用Auto.库会自动选择合适的大小
type: docs
weight: 490
...
将用于的 QR 类型[`BarcodeConfig`](../../aspose.omr.generation.config.elements/barcodeconfig) 负责由 QR 编码的最大字节数。 如果不确定 - 使用Auto.库会自动选择合适的大小
...
| Version19 | `19` | 代表 QR 版本 19 |
| Version20 | `20` | 代表二维码版本 20 |
| Version21 | `21` | 代表二维码版本 21 |
| Version22 | `22` | 代表二维码版本 22 |
| Version23 | `23` | 代表二维码版本 23 |
| Version24 | `24` | 代表二维码版本 24 |
| Version25 | `25` | 代表 QR 版本 25 |
| Version26 | `26` | 代表 QR 版本 26 |
| Version27 | `27` | 代表二维码版本 27 |
| Version28 | `28` | 代表二维码版本 28 |
...
| VersionM1 | `101` | 代表 QR 版本 M1 |
| VersionM2 | `102` | 代表二维码版本 M2 |
| VersionM3 | `103` | 代表 QR 版本 M3 |
| VersionM4 | `104` | 代表 QR 版本 M4 |
