...
description: "将表单页面保存为交互式 PDF，使用户能够直接在电脑或智能手机上填写字段并电子提交。"
type: docs
weight: 50
url: /zh/net/aspose.omr.batchprocessings/templateexporter/exportpageinteractivepdf/
---
...
| 异常 | 条件 |
| --- | --- |
| InvalidOperationException | 如果在推进光标（调用 MoveNext）之前调用 |
