...
| 班级 | 描述 |
| --- | --- |
| [AnswerConfig](./answerconfig) | 代表答案元素。 可以用作子元素[`VerticalChoiceBoxConfig`](../aspose.omr.generation.config.elements.parents/verticalchoiceboxconfig) |
...
| [VerticalChoiceBoxConfig](./verticalchoiceboxconfig) | VerticalChoiceBox 由一个[`AnswerConfig`](../aspose.omr.generation.config.elements.parents/answerconfig)包含简短响应的元素和[`ContentConfig`](../aspose.omr.generation.config.elements/contentconfig)详细描述响应选项的元素。 它也可以包含一个[`WriteInConfig`](../aspose.omr.generation.config.elements/writeinconfig)用户可以在其中输入自己的答案的元素。 |
