...
description: "可用于模板生成的图像集合"
type: docs
weight: 17
url: /zh/java/com.aspose.omr/imagecollection/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [ImageCollection()](#ImageCollection) | 用于创建集合实例的默认构造函数 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [add(String imageName, InputStream stream)](#add-java.lang.String-java.io.InputStream) | 将图像插入此集合。 |
