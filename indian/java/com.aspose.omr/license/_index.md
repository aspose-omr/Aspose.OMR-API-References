...
type: docs
weight: 18
url: /hi/java/com.aspose.omr/license/
---
...
इस उदाहरण में, घटक वाली फ़ोल्डर में, कॉलिंग असेंबली वाली फ़ोल्डर में, एंट्री असेंबली वाली फ़ोल्डर में, और फिर कॉलिंग असेंबली के एम्बेडेड संसाधनों में MyLicense.lic नामक लाइसेंस फ़ाइल को खोजने का प्रयास किया जाएगा।
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| स्ट्रीम | java.io.InputStream | लाइसेंस स्ट्रीम |
...
| पैरामीटर | प्रकार | विवरण |
| --- | --- | --- |
| licenseName | java.lang.String | पूरा या छोटा फ़ाइल नाम या एम्बेडेड संसाधन का नाम हो सकता है। मूल्यांकन मोड में स्विच करने के लिए खाली स्ट्रिंग का उपयोग करें। |
