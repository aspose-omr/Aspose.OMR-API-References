...
description: عنصر الشبكة . قم بإنتاج مصفوفة من الفقاعات. تمثل كل فقاعة مملوءة رمزًا واحدًا في value المركب سيتم ربط جميع الرموز المميزة بعلامة واحدة في value
type: docs
weight: 110
...
عنصر الشبكة . قم بإنتاج مصفوفة من الفقاعات. تمثل كل فقاعة مملوءة رمزًا واحدًا في value المركب سيتم ربط جميع الرموز المميزة بعلامة واحدة في value
...
| [ColumnsCount](../../aspose.omr.generation.config.elements/compositegridconfig/columnscount) { get; set; } | كمية الأعمدة داخل الشبكة. يمثل كل عمود رمزًا واحدًا في النتيجة value يجب أن يكون المبلغ مساويًا لـ[`ExtraRow`](./extrarow) كمية الأعمدة |
...
| [RotationAngle](../../aspose.omr.generation.config.elements/compositegridconfig/rotationangle) { get; set; } | وصف دوران عنصر الشبكة حول محوره . "90" - تدوير الشبكة المركبة 90 درجة "-90" - تدوير ComopositeGrid إلى -90 درجة |
| override [Type](../../aspose.omr.generation.config.elements/compositegridconfig/type) { get; set; } | نوع عنصر omr. حقل مطلوب لتسلسل JSON . |
| [Values](../../aspose.omr.generation.config.elements/compositegridconfig/values) { get; set; } | مجموعة من السلاسل التي تصف الرموز المحتملة في كل عمود. يتم وضع القيم الخاصة بالعمود في[`ExtraRow`](./extrarow) |
