...
| [CompositeGridConfig](./compositegridconfig) | عنصر الشبكة . قم بإنتاج مصفوفة من الفقاعات. تمثل كل فقاعة مملوءة رمزًا واحدًا في value المركب سيتم ربط جميع الرموز المميزة بعلامة واحدة في value |
