...
يمثل جدولًا من الفقاعات. معرف السؤال وإجابات متعددة للاختيار. يمكن أن يكون خط الإجابات أفقيًا أو عموديًا.
...
| الاسم | الوصف |
| --- | --- |
| [GridConfig](gridconfig)() | المنشئ الافتراضي. |
...
| [XPosition](../../aspose.omr.generation.config.elements/gridconfig/xposition) { get; set; } | موضع X للشبكة على الصفحة، يتجاوز المحاذاة |
| [YPosition](../../aspose.omr.generation.config.elements/gridconfig/yposition) { get; set; } | موضع Y للشبكة على الصفحة، يتجاوز المحاذاة |
