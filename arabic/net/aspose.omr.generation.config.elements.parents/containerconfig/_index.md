...
| [ColumnsCount](../../aspose.omr.generation.config.elements.parents/containerconfig/columnscount) { get; set; } | كمية الأعمدة داخل الحاوية. مقسمة على أعمدة متساوية. نسخة قديمة من[`Proportions`](./proportions) |
