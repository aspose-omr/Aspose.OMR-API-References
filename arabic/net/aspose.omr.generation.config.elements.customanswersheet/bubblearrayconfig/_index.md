...
description: عرض الإجابات المحتملة كخيارات لكل دائرة داخلية فقاعة . يمكن استخدامها في الداخل فقطCustomRowConfig./customrowconfig
type: docs
weight: 130
...
عرض الإجابات المحتملة كخيارات لكل دائرة داخلية (فقاعة) . يمكن استخدامها في الداخل فقط[`CustomRowConfig`](../customrowconfig)
