...
description: نوع QR الذي سيتم استخدامهBarcodeConfig../aspose.omr.generation.config.elements/barcodeconfig مسؤول عن الحد الأقصى من وحدات البايت المشفرة بواسطة QR. إذا لم تكن متأكدًا  استخدمAuto . ستحدد المكتبة الحجم المناسب تلقائيًا
type: docs
weight: 490
