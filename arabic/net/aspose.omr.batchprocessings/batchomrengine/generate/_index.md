...
| معامل | النوع | الوصف |
| --- | --- | --- |
| dataSet | DataSet | مجموعة من مجموعات البيانات المستخدمة في توليد نماذج القالب |
| layoutStream | Stream | دفق مع تخطيط القالب |
| الإعدادات | GlobalPageSettings | إعدادات الصفحة المستخدمة في كل توليد نموذج القالب |
| مجموعة | ImageCollection | مجموعة الصور المستخدمة في كل توليد نموذج القالب |

### قيمة الإرجاع

نتيجة توليد مجموعة من القوالب
...
| --- | --- | --- |
| dataSet | DataSet | مجموعة من مجموعات البيانات المستخدمة في توليد نماذج القالب |
| layoutPath | سلسلة | مسار إلى ملف يحتوي على تخطيط القالب |
| الإعدادات | GlobalPageSettings | إعدادات الصفحة المستخدمة في كل توليد نموذج القالب |
| مجموعة | ImageCollection | مجموعة الصور المستخدمة في كل توليد نموذج القالب |
...
| --- | --- | --- |
| dataSet | DataSet | مجموعة من مجموعات البيانات المستخدمة في توليد نماذج القالب |
| layoutLines | String[] | مصفوفة مرتبة من السطور تمثل تخطيط القالب |
| الإعدادات | GlobalPageSettings | إعدادات الصفحة المستخدمة في كل توليد نموذج القالب |
| مجموعة | ImageCollection | مجموعة الصور المستخدمة في كل توليد نموذج القالب |
