...
description: "نتيجة إنشاء قوالب متعددة."
type: docs
weight: 60
url: /ar/net/aspose.omr.batchprocessings/batchgenerationresult/
---
## BatchGenerationResult class

نتيجة إنشاء قوالب متعددة.
...
| الاسم | الوصف |
| --- | --- |
| [BatchGenerationResult](batchgenerationresult)() | المنشئ الافتراضي. |
