...
| معامل | النوع | الوصف |
| --- | --- | --- |
| fullPath | String | المسار النسبي أو المطلق لصورة النموذج المُولَّدة. |
| elementsCount | Int32 | إجمالي عدد الأسئلة في التقييم التكميلي. |
| columns | Int32 | عدد الأعمدة لترتيب الأسئلة فيها. استخدم أعمدة متعددة لجعل الورقة أكثر تجميعًا. |
| answersCount | Int32 | إجمالي عدد الفقاعات (الإجابات) لكل سؤال. |
| title | String | عنوان اختياري لورقة الفقاعات. |
