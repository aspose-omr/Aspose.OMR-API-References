...
type: docs
weight: 25
url: /ar/java/com.aspose.omr/omrtemplate/
---
...
| طريقة | الوصف |
| --- | --- |
| [addPage()](#addPage) | يضيف صفحة إلى القالب |
| [equals(Object arg0)](#equals-java.lang.Object) |  |
| [getClass()](#getClass) |  |
| [getFinalizationComplete()](#getFinalizationComplete) |  |
| [getName()](#getName) | يحصل أو يعيّن اسم القالب |
| [getPages()](#getPages) | يحصل على قائمة الصفحات في القالب |
...
| [setName(String value)](#setName-java.lang.String) | يحصل أو يعيّن اسم القالب |
| [setPages(System.Collections.Generic.List<OmrPage> value)](#setPages-com.aspose.ms.System.Collections.Generic.List-com.aspose.omr.OmrPage) | يعيّن قائمة الصفحات في القالب |
...
ينشئ مثيلاً جديداً من الفئة [OmrTemplate](../../com.aspose.omr/omrtemplate/)
...
يحصل أو يعيّن نسخة ترميز القالب
...
يحصل أو يعيّن اسم القالب

**Returns:**
java.lang.String - اسم القالب
### getPages() {#getPages}
```
...
يحصل على قائمة الصفحات في القالب

**Returns:**
com.aspose.ms.System.Collections.Generic.List<com.aspose.omr.OmrPage> - قائمة الصفحات في القالب
### getTemplateId() {#getTemplateId}
```
...
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | java.lang.String | اسم القالب |
...
يعيّن قائمة الصفحات في القالب

**Parameters:**
| معامل | نوع | الوصف |
| --- | --- | --- |
| قيمة | com.aspose.ms.System.Collections.Generic.List<com.aspose.omr.OmrPage> | قائمة الصفحات في القالب |
