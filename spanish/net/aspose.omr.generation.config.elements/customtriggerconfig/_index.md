...
description: Burbuja personalizada. Al llenar puede cambiar el comportamiento  valor de los elementos de destino
type: docs
weight: 160
...
| override [Name](../../aspose.omr.generation.config.elements/customtriggerconfig/name) { get; set; } | Nombre del activador. |
