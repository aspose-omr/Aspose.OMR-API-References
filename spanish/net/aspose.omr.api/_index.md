...
| Clase | Descripción |
| --- | --- |
| [ImageCollection](./imagecollection) | Colección de imágenes que se pueden usar para la generación de plantillas. ej.[`GenerateTemplate`](../aspose.omr.api/omrengine/generatetemplate) Puede ser útil cuando sus imágenes no están en el sistema de archivos. |
