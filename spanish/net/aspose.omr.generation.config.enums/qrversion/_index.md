...
description: Tipo de QR que se utilizará paraBarcodeConfig../aspose.omr.generation.config.elements/barcodeconfig Responsable de la cantidad máxima de bytes codificados por QR. Si no está seguro useAuto . La biblioteca seleccionará el tamaño apropiado automáticamente
type: docs
weight: 490
