...
description: Cantidad de píxeles. Se puede usar para agregar espacio adicional sobre el elemento. O elimine el espacio existente configurando un valor negativo por ejemplo 40
type: docs
weight: 50
