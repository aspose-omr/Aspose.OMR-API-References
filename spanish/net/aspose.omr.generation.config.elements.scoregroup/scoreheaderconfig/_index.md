...
description: Columna enScoreGroupConfig./scoregroupconfig eso almacenará la cantidad de puntos para cada respuesta. Si está ausente esa columna no se dibujará.
type: docs
weight: 300
